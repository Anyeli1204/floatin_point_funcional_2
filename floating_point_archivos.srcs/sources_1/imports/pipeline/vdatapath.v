...
module vdatapath(
    ...
    // 1023 * 4 para guardar los valores "basura", una vez acabe el for
    wire [31:0] addr_c = (advance) ? addrM3 + ((curr_i * num_j + curr_j) << 2) : 32'd4096;    //wire [31:0] addr_c = addrM3 + ((curr_i * num_j + curr_j) << 2);
